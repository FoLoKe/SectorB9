...
public class ItemsDataSheet
{
	...
	public ItemsDataSheet(MainActivity MA)
	{
		...
		objects.add(new ItemInfo("iron ore"			,1	,InventoryAsset.inv_item_fe			,new int[]{0}				,new int[]{0}				,4					,0			,0			,0			,"can be mined on asterods by drilling them or destroying"));
		objects.add(new ItemInfo("gold ore"			,2	,InventoryAsset.inv_item_au			,new int[]{0}				,new int[]{0}				,5					,0			,0			,0			,"can be mined on asterods by drilling them or destroying"));
		objects.add(new ItemInfo("silicon ore"			,3	,InventoryAsset.inv_item_si			,new int[]{0}				,new int[]{0}				,6					,0			,0			,0			,"can be mined on asterods by drilling them or destroying"));
