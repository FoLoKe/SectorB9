...
public class ObjectOptionsUI
{
	...
	public static void init(final StaticEntity target,final ViewFlipper IVF,MainActivity MA)
	{
		...
		LinearLayout LR=IVF.findViewById(R.id.object_options_uiLinearLayout);
